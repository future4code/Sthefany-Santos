...
// "Amanda Rangel", "Laís Petra" e "Letícia Chijo",
...
//vai entrar Amanda e Laís, Chijo não
...
// const cachorroSalsicha = pets.filter((cachorro) => {
...
// //
// const produtosDesconto = produtos.map((prod) => {
//   return {nome: prod.nome, preco: (prod.preco * 0.95)}
// });
