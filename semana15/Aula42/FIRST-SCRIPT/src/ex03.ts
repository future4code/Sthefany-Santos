...
//   a) Copie o código acima para um arquivo .ts. Depois, crie um type para representar um post e utilize-o para fazer 
//   a tipagem do array posts.
...
// Quais são as entradas e saídas dessa função? Copie a função para o mesmo arquivo .ts do array de posts e faça a tipagem 
// necessária.

// entradas: post e autor 
// saidas: filtro do post com o autor pesquisado
